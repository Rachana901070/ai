...
const PickupSchema = new mongoose_1.Schema({
    ...
    collectorId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User', required: true, index: true },
    status: { type: String, enum: ['accepted', 'en_route', 'picked_up', 'delivered', 'cancelled'], default: 'accepted', index: true },
}, { timestamps: true });
exports.Pickup = mongoose_1.default.models.Pickup || mongoose_1.default.model('Pickup', PickupSchema);
